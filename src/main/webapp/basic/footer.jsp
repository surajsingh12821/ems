...
<footer class="text-center text-lg-start ">
  ...
  <section
    class="d-flex justify-content-center justify-content-lg-between p-2 border-bottom bg-primary  text-black bg-opacity-50 fs-6"
  >
    <!-- Left -->
  ...
  <!-- Copyright -->
  <div class="text-center p-2 bg-primary  text-black bg-opacity-50">
