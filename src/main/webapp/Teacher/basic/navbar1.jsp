...
<nav class="navbar navbar-expand-lg fw-bold text-dark  text-black"
	style="background-color:rgba(92, 219, 198)">
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse justify-content-center"
			...
			<ul class="navbar-nav">
				<li class="nav-item m-2"><h4><i class="bi bi-bell-fill"></i></h4></li>
				
				<li class="nav-item m-2"><h4><i class="bi bi-envelope"></i></h4></li>
			</ul>
