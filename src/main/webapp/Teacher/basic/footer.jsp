...
<footer class="text-center text-lg-start ">
  ...
  <section
    class="d-flex justify-content-center justify-content-lg-between p-2 border-bottom  fs-6"style="background-color:rgba(92, 219, 198)">
    <!-- Left -->
      ...
      <div class="row mt-2">
        ...
        <div class="col-md-7 col-lg-7 col-xl-5 mx-auto   mb-4">
          ...
          <h6 class="text-uppercase fw-bold mb-4">
           <h4> <i class="fas fa-gem me-3"></i>Education Management System</h4>
          </h6>
          <p>
  ...
  <!-- Copyright -->
  <div class="text-center p-2 mt-2"style="background-color:rgba(92, 219, 198)">
