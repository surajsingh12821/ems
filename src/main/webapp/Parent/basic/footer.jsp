...
<footer class="text-center text-lg-start ">
  ...
  <section
    class="d-flex justify-content-center justify-content-lg-between p-2 border-bottom  fs-6" style="background-color:rgba(171, 222, 226, 1)">
    <!-- Left -->
  ...
  <!-- Copyright -->
  <div class="text-center p-2"style="background-color:rgba(171, 222, 226, 1)">
